...
BASE=$(pwd)
PROGRAM_JAR=$BASE/../../../examples/control/prevayler-1.0-SNAPSHOT.jar
MAIN_CLASS=${ARG1}
PROGRAM_NAME=${ARG0}
...
#    ../../../target/jre-inst-implicit-optimized/bin/java -Xbootclasspath/a:../../../target/Phosphor-0.0.5-SNAPSHOT.jar -javaagent:../../../target/Phosphor-0.0.5-SNAPSHOT.jar=taintSources=../../../examples/control/prevayler-sources -cp $program_jar $main_class $arg0 $arg1 $arg2 $arg3
