...
BASE=$(pwd)
PROGRAM_JAR=$BASE/../../../examples/control/lucene-demo-7.4.0.jar
DEPENDENCIES=$BASE/../../../examples/control/lucene-analyzers-common-7.4.0.jar:$BASE/../../../examples/control/lucene-core-7.4.0.jar
